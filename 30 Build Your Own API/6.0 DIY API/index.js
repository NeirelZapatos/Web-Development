...
app.get("/filter", (req, res) => {
  const filteredActivities = jokes.filter((joke) => joke.jokeType === req.query.type);
...
app.patch("/jokes/:id", (req, res) => {
  const existingJoke = jokes.find((joke) => joke.id == req.params.id);
  const editedJoke = {
    id: req.params.id,
...
//8. DELETE All jokes
app.delete("/jokes/delete/all", (req, res) => {
